...
# reviewed by hand, see `check_findings.md`
DROP_LIST = ("ZANUBRUTINIB | CAPSULE 80 MG", 
"INFLIXIMAB | SOLUTION FOR INJECTION 120 MG IN 1 ML PRE-FILLED SYRINGE", 
"ADALIMUMAB | INJECTION 40 MG IN 0.8 ML PRE-FILLED SYRINGE",
"MORPHINE | ORAL SOLUTION CONTAINING MORPHINE SULFATE 2 MG PER ML IN 500 ML BOTTLE, 1 ML (S19A)",
"MORPHINE | ORAL SOLUTION CONTAINING MORPHINE SULFATE 2 MG PER ML IN 100 ML BOTTLE, 1 ML (S19A)")